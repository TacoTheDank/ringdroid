...
class FileSaveDialog(context: Context?,
                     resources: Resources,
                     originalName: String,
                     response: Message) : Dialog(context) {
    private lateinit var mTypeSpinner: Spinner
    private lateinit var mFilename: EditText
    private lateinit var mResponse: Message
...
// they're presented in the spinner control
    ...
    init {
        ...
        mTypeSpinner.onItemSelectedListener = object : OnItemSelectedListener {
