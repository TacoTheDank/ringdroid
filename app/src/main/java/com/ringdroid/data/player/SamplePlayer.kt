...
internal class SamplePlayer(private val mSamples: ShortBuffer,
    ...
    private var mPlaybackStart: Int = 0 // Start offset, in samples. = 0
    private var mPlayThread: Thread?
    private var mKeepPlaying: Boolean
    private var mListener: OnCompletionListener? = null

    constructor(sf: SoundFile) : this(sf.samples!!, sf.sampleRate, sf.channels, sf.numSamples) {}
...
// (Assumes mChannels = 1 or 2).
    ...
    init {
        ...
        mAudioTrack = AudioTrack(
            ...
            notificationMarkerPosition = mNumSamples - 1 // Set the marker to the end.
